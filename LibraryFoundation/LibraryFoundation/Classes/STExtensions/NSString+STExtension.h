...
@interface NSString (easyForException)
...
- (NSString *)stringByReplacingOccurrencesOfStringForeasy:(NSString *)target
                                                withString:(NSString *)replacement
                                                   options:(NSStringCompareOptions)options
                                                     range:(NSRange)searchRange;

- (NSString *)stringByReplacingCharactersInRangeForeasy:(NSRange)range
                                              withString:(NSString *)replacement;

@end


@interface NSMutableString (easyForException)
