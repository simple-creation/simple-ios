...
@implementation NSString (easyForException)

- (NSString *)substringFromIndexForeasy:(NSUInteger)from
{
    if (from <= self.length) {
        return [self substringFromIndex:from];
    }
...
- (NSString *)substringToIndexForeasy:(NSUInteger)to
{
    if (to <= self.length) {
        return [self substringToIndex:to];
    }
...
- (NSString *)substringWithRangeForeasy:(NSRange)range
{
    if (range.location+range.length <= self.length) {
        return [self substringWithRange:range];
    }
...
- (NSString *)stringByAppendingStringForeasy:(NSString *)aString
{
    if (nil != aString) {
...
- (NSString *)stringByPaddingToLengthForIndexForeasy:(NSUInteger)newLength withString:(NSString *)padString startingAtIndex:(NSUInteger)padIndex
{
...
- (NSString *)stringByReplacingOccurrencesOfStringForeasy:(NSString *)target withString:(NSString *)replacement options:(NSStringCompareOptions)options range:(NSRange)searchRange
{
...
- (NSString *)stringByReplacingCharactersInRangeForeasy:(NSRange)range withString:(NSString *)replacement
{
    if (range.location + range.length <= self.length) {
...
@implementation NSMutableString (easyForException)

- (void)replaceCharactersInRangeForeasy:(NSRange)range withString:(NSString *)aString
{
...
- (void)insertStringForeasy:(NSString *)aString atIndex:(NSUInteger)loc
{
...
- (void)deleteCharactersInRangeForeasy:(NSRange)range
{
    if (range.location + range.length <= self.length) {
...
- (void)appendStringForeasy:(NSString *)aString
{
    if (nil != aString) {
...
- (void)setStringForeasy:(NSString *)aString
{
    if (nil != aString) {
...
- (NSUInteger)replaceOccurrencesOfStringForeasy:(NSString *)target withString:(NSString *)replacement options:(NSStringCompareOptions)options range:(NSRange)searchRange
{
